...
Propositions 1 and A are proved; the certification is a computation with rigorous error bounds; everything else is measurement with stated numbers. Scripts: \texttt{code/music\_zeros.py}, \texttt{code/positivite\_certifiee.py}, zero caches \texttt{code/zeros\_zeta\_90\_hp.pkl}, \texttt{zeros\_chi3\_hp.pkl}. The recovery of zeros from the truncated form is the superexponential convergence observed by Groskin (arXiv:2605.20224), and the exactness of the zero-side identity on $V$ is his finite Guinand--Weil dictionary (arXiv:2607.02828); our contribution is the lens --- the admission bound, the subspace formulation, the Gram duality, and the laws that tie precision to depth.
\end{document}
