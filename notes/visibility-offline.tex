...
\]
with $F_0=\hat f(\tfrac12+i\gamma)$, $F_1=\int f(x)\,x\,e^{i\gamma x}\,dx$.
Then
\[
\hat g(\rho)=F_0^2-\sigma^2 F_1^2+O(\sigma^2 F_0)+O(\sigma^4).
\]
...
exponentially small. The moment $F_1(\gamma_1)$ is $O(\tau\|f\|)$ and
numerically $O(1)$ on $V_9$ at $\mu=11$ ($F_1^2\approx0.54$ from
$\hat g=-5.4\times10^{-5}$ at $\sigma=0.01$). Hence on that vector
\[
