...
"""Schur tail for χ₇ on W_log3. The χ(2)=+1 cell.

q=7, d=−7, s₀=3/4, w₂=+log2/√2. Grid h=2,4,8,16,20,24.
...
def run() -> dict:
    ...
    return {
        ...
        "chi7_taken": bool(pos) and by[2]["s_lo_pos"],
...
def main() -> int:
    print(
        "χ₇ Schur; χ(2)=+1; h=2,4,8,16,20,24; β=#60+T₂; S_lo=#61; "
    ...
    print(
        f"chi7_taken={data['chi7_taken']}  first_h={data['first_positive_h']}  "
