...
euler = arb.const_euler()   # boule certifiee ; la chaine de 85 chiffres avait un rayon 1e-86 < son erreur 4,7e-86 (boule invalide)
...
print(f"[{time.time()-t0:.0f}s] CERTIFIE : Q(mu=11) definie positive (pire marge Gershgorin {worst[0]:.2e}, ligne {worst[1]})")
